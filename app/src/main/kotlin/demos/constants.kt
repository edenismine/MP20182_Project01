...
val SANDWICHERIA_MENU = listOf(
        SANDWICH + WHITE_CHEESE,
        SANDWICH + WHITE_CHEESE + WHITE_CHEESE,
        SANDWICH + HAM,
        SANDWICH + CHICKEN,
        SANDWICH + HEAD_CHEESE,
        SANDWICH + SAUSAGE,
        SANDWICH + HAM + WHITE_CHEESE,
        SANDWICH + CHICKEN + WHITE_CHEESE,
        SANDWICH + HEAD_CHEESE + WHITE_CHEESE,
        SANDWICH + SAUSAGE + WHITE_CHEESE,
        SANDWICH + HAM + WHITE_CHEESE + WHITE_CHEESE,
        SANDWICH + CHICKEN + WHITE_CHEESE + WHITE_CHEESE,
        SANDWICH + HEAD_CHEESE + WHITE_CHEESE + WHITE_CHEESE,
        SANDWICH + SAUSAGE + WHITE_CHEESE + WHITE_CHEESE
)
